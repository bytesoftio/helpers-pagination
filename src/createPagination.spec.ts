...
describe("createPagination", () => {
  it("creates page range", () => {
    const result1 = createPagination({currentPage: 1, totalItems: 3, pageSize: 2, surroundBy: 0})
    ...
    const result2 = createPagination({currentPage: 1, totalItems: 7, pageSize: 2, surroundBy: 1})
    ...
    const result3 = createPagination({currentPage: 4, totalItems: 17, pageSize: 2, surroundBy: 2})
    ...
    const result4 = createPagination({currentPage: 6, totalItems: 33, pageSize: 5, surroundBy: 2})
    ...
    const result5 = createPagination({currentPage: 6, totalItems: 0, pageSize: 5, surroundBy: 2})
    ...
    const result6 = createPagination({currentPage: 4, totalItems: 7, pageSize: 2, surroundBy: 1})
